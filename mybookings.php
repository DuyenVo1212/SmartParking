...
<head>
    <title>View Your Booking and Status </title>
    ...
    <section id="container">
        ...
        <section id="content">
            ...
            <div id="InUse" class="tab-content" style="display:none">
                <?php
					$phone = $_SESSION["phone"];
					$query = "select * from zones where phone = '$phone' and status ='INUSE'";
					$result = $conn->query($query);
					if ($result->num_rows ==0) {
                        ...
                        $refund = ""; // initialize the variable as an empty string
            ...
            <div class="note">
                ...
                <div class="note-content">
                    <ol>
                        <li>Please arrive on time for your parking reservation. The website allows a 15-minute grace
                            period, after which your reservation will be automatically cancelled.</li>
                        <li>
                            Once parked, please follow the general regulations and only park within the allowed time
                            frame.
                            We
                            will not be responsible for handling your vehicle if you exceed the allotted time.</li>
