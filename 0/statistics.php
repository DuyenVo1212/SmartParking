			...
			<div>
				...
				<div style="width:660px;background:white;padding:10px;margin:auto;">
					<form method="post" action="" >
						<input type="text" name="year" require placeholder="<?php echo date("Y"); ?>" value="<?php echo $year ?>" style="width: 50px; height: 30px;">
						...
						<span class="btn btn-success" style="padding: 3.8px 5px;border:1px solid black;margin-top: -11px;"><?php echo " $month";echo "/"; echo "$year ";?></span>
					</form>
					<hr>
					<h5 style="width:640px; margin: auto;">Thống kê số lượng đặt trước theo tháng <?php echo " $month";echo "/"; echo "$year ";?> là :<?php echo " $total "; ?> lượt đặt/tháng.</h5>
					<hr>
